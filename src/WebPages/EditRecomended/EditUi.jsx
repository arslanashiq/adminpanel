...
export const Edit = () => {
    ...
    const uploadData = () => {
        const url = URL.My_Database_Url +'recomended/' + params.id;
                ...
                <Stack direction={"row"}>
                    ...
                    <Stack spacing={2}>
                        ...
                        <Stack spacing={2} direction={"row"}>
                            ...
                            <TextField sx={{ paddingBottom: 2 }} value={Price} onChange={(e) => setPrice(e.target.value)} variant="outlined" />
                        </Stack>
                        ...
                        <Stack spacing={2} direction={"row"}>
                            ...
                            <TextField multiline sx={{ width: 300, paddingBottom: 2 }} value={Info} onChange={(e) => setInfo(e.target.value)} variant="outlined" />
                        </Stack>
                        ...
                        <Stack spacing={2} direction={"row"}>
                            ...
                            <TextField multiline sx={{ width: 300, paddingBottom: 2 }} value={sizename} onChange={(e) => setsizename(e.target.value)} variant="outlined" />
                            <TextField multiline sx={{ width: 300, paddingBottom: 2 }} value={sizeprice} onChange={(e) => setsizeprice(e.target.value)} variant="outlined" />
                        ...
                        <Stack spacing={2} direction={"row"}>
                            ...
                            <TextField multiline sx={{ width: 300, paddingBottom: 2 }} value={ingname} onChange={(e) => setingname(e.target.value)} variant="outlined" />
